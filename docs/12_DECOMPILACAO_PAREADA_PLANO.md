...
| 7 | **Fase -1 de host readiness (Linux + Windows)** amarrada ao `docs/11` | Este host e Linux: Ghidra via pacman, JDK 21, `m68k-elf-gcc` ausente, cores Libretro `.so` ausentes |
