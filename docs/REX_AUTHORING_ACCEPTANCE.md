...
O build final testado tem SHA-256 `9224bdd04343d14402e83b61d842a4ee0fe485c62805bb6715b1fbcfc629cb37`. O E2E de autoria guiada passou 10/10, agora com preview 160×32 e pixels reais de pelagem, cachecol, espada, grama, céu e montanhas no canvas antes e depois de reiniciar. O E2E de referência passou 16/16, incluindo input nativo, salto, pausas e passagem persistida. Relatórios e capturas finais (`22-13`/`22-14`) versionados em [`data/reference_platformer_art/doc/evidence`](../data/reference_platformer_art/doc/evidence); os da execução anterior (`22-00`/`22-02`) foram preservados. A ROM final jogada tem SHA-256 `01ebd95e508c8b821b0746d8453706d7e282d515cc16ad6233a68c5524c463b8`.
