...
**Ultima revisao canonica:** 2026-05-27 (rodada 64 - Asset Browser X curado)
...
| Asset Browser                          | Experimental | Em codigo     | Em hardening  | Rodada 64 em `codex/asset-browser-production-x-rebased`: busca/filtros por tipo/gerado/orfao/over-budget, preview seguro, "Usado por" com cena/grafo, budget rapido, insercao na Scene, ponte ArtStudio e QA RC A-H `qa-rc-2026-05-27T09-49-29-979Z-*`; rotulo `experimental` permanece alinhado ao roadmap | Acompanhar PR/checks remotos, manter rotulo e repetir QA institucional quando o fluxo de assets mudar | Nao                           |
