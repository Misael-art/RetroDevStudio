...
**Versao:** 2.0
**Ultima revisao:** 2026-07-06 (v2 — triagem por tier, curriculo de aprendizado, biblioteca de insumo local, host Linux; scripts versionados, Ghidra boundary benchmark medido, holdout v2 corrigido)
