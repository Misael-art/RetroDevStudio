...
mod tests {
    ...
    fn main_c_emits_logic_var_math_and_compare_branching() {
        ...
        assert!(output.main_c.contains("SND_startPlayPCM_XGM(SFX_WIN, 1, SOUND_PCM_CH_AUTO);"));
        assert!(output.main_c.contains("} else {"));
        assert!(output.main_c.contains("SND_startPlayPCM_XGM(SFX_LOSE, 1, SOUND_PCM_CH_AUTO);"));
    }
