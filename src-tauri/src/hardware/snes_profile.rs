...
pub fn hw_status_with_source_kind(scene: &Scene, source_kind: Option<&str>) -> HwStatus {
    ...
    HwStatus {
        ...
        analysis_mode: "native_static".to_string(),
        project_asset_bytes: vram_used,
        resident_vram_bytes: vram_used,
        streamable_vram_bytes: 0,
        dma_frame_bytes: vram_used,
        sprite_resident_bytes: vram_used,
        tilemap_resident_bytes: 0,
        hud_resident_bytes: 0,
        streamable_sprite_bytes: 0,
        animated_swap_bytes: 0,
        managed_concurrent_sprite_banks: 0,
        managed_sprite_cells_used: 0,
        managed_sprite_banks_limit: 0,
        managed_sprite_cells_budget: 0,
        sprite_count,
