...
Os pixels de produção foram redesenhados em `reference_player_ppm`, `reference_goal_ppm`, `reference_passage_ppm` e `reference_tileset_ppm` no backend canônico. O sprite final tem cinco poses de 16×16; a bandeira mede 16×16, o portão 16×32 e o cenário 320×224. Cada recurso usa no máximo 16 cores na sua paleta Mega Drive. O template continua **Experimental** e autocontido; nenhuma ROM ou asset BYOR foi incorporado.
